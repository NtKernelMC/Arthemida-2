 ...
 *
 *****************************************************************************/
#include "../../Arthemida-2/ArtUtils/SString.h"
#include <cassert>
#include <algorithm>
#include "../../Arthemida-2/ArtUtils/SharedUtil.Defines.h"
//EXPLICIT!
//ToLower
//ToUpper
//SubStr
...
namespace MtaUtils
{
    ...
    {
        return _stricmp(*this, strOther) == 0;
    }
    ...
    {
        return _stricmp(Right((int)strOther.length()), strOther) == 0;
    }
    ...
    {
        return _stricmp(Left((int)strOther.length()), strOther) == 0;
    }
